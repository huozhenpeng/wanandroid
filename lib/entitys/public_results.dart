class PublicResult {
  ...
  PublicResult({this.data, this.errorCode, this.errorMsg});

  PublicResult.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new PublicData.fromJson(json['data']) : null;
...
class PublicData {
  ...
  PublicData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<PublicItem>();
      json['datas'].forEach((v) {
        datas.add(new PublicItem.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class PublicItem {
  ...
  PublicItem.fromJson(Map<String, dynamic> json) {
