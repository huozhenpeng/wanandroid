class NavResult {
  ...
  NavResult({this.data, this.errorCode, this.errorMsg});

  NavResult.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<NavItem>();
      json['data'].forEach((v) {
        data.add(new NavItem.fromJson(v));
      });
    }
...
class NavItem {
  ...
  NavItem({this.articles, this.cid, this.name});
